...
app.controller("subjectsController", [ "$scope", "subjectService", function($scope, subjectService) {
    ...
    /*topicService.getTopics(function(response) {
    ...
    var questionService = function() {
        return {
            ...
            getList: function(callback) {
                $http.get("/enem/question/").success(function(response) {
                    callback(response);
                }).error(this.defaultErrorCallback);
            },
            sendAnswers: function(data, callback) {
                $http.post("/enem/results/", data).success(function(response) {
                    callback(response);
                }).error(this.defaultErrorCallback);
            }
        };
    ...
    var subjectService = function() {
        return {
            getSubjects: function(callback) {
                $http.get("/enem/subjects/").success(function(response) {
                    callback(response);
                });
            }
        };
    ...
    var topicService = function() {
        return {
            getTopics: function(callback) {
                $http.get("/enem/topics/").success(function(response) {
                    callback(response);
                });
            }
        };
...
app.controller('loginController', ['$scope', '$http', function($scope, $http, $user) {
    ...
    this.log = function() {
      ...
      $http.get("/enem/user/'" + $scope.login + "'/'" + $scope.pssw + "'").success(function(response) {
        alert(response);
        if(response == "true") {
          window.location.href = "index" ;
          $http.post("/enem/logado/'" + $scope.login + "'").success(function(response) {
            alert("Logado: " + response);
          });
